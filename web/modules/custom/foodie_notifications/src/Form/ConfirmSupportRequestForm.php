...
namespace Drupal\foodie_notifications\Form;

use Drupal\Core\Form\ConfirmFormBase;
use Drupal\Core\Form\FormStateInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Drupal\node\NodeInterface;
use Drupal\foodie_notifications\Service\NotificationService;
...
class ConfirmSupportRequestForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\foodie_notifications\Service\NotificationService
   */
   ...
   *
   * @param \Drupal\foodie_notifications\Service\NotificationService $notification_service
   *   The notification service.
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('foodie_notifications.notification_service'),
