...
namespace Drupal\foodie_contact_form\Form;
...
class WorkoutForm extends FormBase {
   ...
   *
   * @param \Drupal\foodie_contact_form\WorkoutChallengeService
  ...
  public function getFormId() {
    ...
    return 'foodie_contact_form_workout_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $tags = ['foodie_contact_form_leaderboard'];
